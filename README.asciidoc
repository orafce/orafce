...
bitand, nanvl, sinh, cosh, tanh, oracle.substr, oracle.mod and oracle.remainder.
...
* oracle.mod(int, int) - Oracle compatible mod, If the second parameter is zero, it returns the first parameter
* oracle.remainder(int, int) - Oracle compatible remainder, If the first parameter is zero, it raises an exception
